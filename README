...
If you want to, for whatever reason, use the files, just `git clone` and then `yarn` and `yarn` start. In case you don't have the Webpack Dev Server not installed, add a `yarn global add webpack-dev-server` before that and you should be good to go.
